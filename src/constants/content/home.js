export const HOME_CONTENT = {
  en: {
    ...
    saturday: "Saturday (English)",
    sunday: "Sunday (Ukrainian)",
    holyDays: "Holy Days",
  ...
  ua: {
    ...
    saturday: "Субота (Англійською)",
    sunday: "Неділя (Українською)",
    holyDays: "Свята",
    ...
    history:
      "UA | Founded in 1921, our church is located in the heart of historic Morris County, five miles from Morristown, in the town of Whippany, New Jersey. It is a very active and growing parish with a new campus that includes our newly consecrated church as well as the 24,000 square foot Ukrainian American Cultural Center of NJ.",
